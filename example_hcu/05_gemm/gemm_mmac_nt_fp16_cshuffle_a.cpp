...
using DeviceGemmInstance0 =
    ck::tensor_operation::device::DeviceGemm_mmac_nt_m0k0k1m1_n0k0k1n1_nm_v1_cshuffle<
        ...
        32,  // M1PerBlock
        4,   // N0PerBlock (NPerBlock = 4 * 32 = 128)
        32,  // N1PerBlock
        2,   // K0PerBlock
        16,  // K1PerBlock
        16,  // MPerMmac
        16,  // NPerMmac
        2,   // MwaveRepeat (MwaveRepeat=2 makes MWaves = 256 / (2*1*16*2) = 4)
        4,   // NwaveRepeat (NwaveRepeat=4 makes NWaves = 128 / (4*2*16*1) = 1)
        1,   // MmmacRepeat
        2,   // NmmacRepeat
        2,   // MmmacInterleave
        1,   // NmmacInterleave
        ...
        4,
        8,
        1,   // CShuffleMwaveRepeatPerShuffle
        2,   // CShuffleNwaveRepeatPerShuffle
        S<1, 1, 16, 1, 1, 16>,
        4,
        2>;
